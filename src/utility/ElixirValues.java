...
public interface ElixirValues {
	...
	String[] E1 = {"Juju Ember", "Warms the heart, warm enough so you forget it's hot outside. May cause involuntary blushing and uncomfortable bathroom breaks.", "22.30"};
	String[] E2 = {"Phoenix Down", "The tailfeather of a bird, able to bring one back from the verge of death. Billed by ambitious merchants as having been plucked from the legendary phoenix, the truth of such claims are unsubstantiated. None can deny its power, however, bringing those who have all but drawn their last breath back to their feet.", "42.23"};
	String[] E3 = {"Zerthul Elixir", "A fine mixture made by the moderately and reasonably mad alchemist Zerthul. Villagers under his control claim absolute recovery in all aspects of their lives regardless of the town's decay and eery surroundings. Certainly an effective elixir, share to your friends Zerthul says.", "4.65"};
