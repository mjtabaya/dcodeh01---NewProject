...
public interface ElixirValues {
	...
	final String[] E3 = {"Zerthul Elixir", "A fine mixture made by the moderately and reasonably mad alchemist Zerthul. Villagers under his control claim absolute recovery in all aspects of their lives regardless of the town's decay and eery surroundings. Certainly an effective elixir, share to your friends Zerthul says.", "4.65"};
